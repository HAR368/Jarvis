...
# # Get correct base path whether running as .py or .exe
...
# Determine correct base path (for .py or PyInstaller .exe)
if getattr(sys, 'frozen', False):
    base_path = sys._MEIPASS
else:
    base_path = os.path.abspath(".")
...
# Main chatbot search + respond logic
def RealtimeSearchEngine(prompt):
    global SystemChatBot, messages
