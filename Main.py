...
# Load .env from correct path depending on .py or .exe
if getattr(sys, 'frozen', False):
    base_path = sys._MEIPASS
else:
    base_path = os.path.abspath(".")

env_vars = dotenv_values(os.path.join(base_path, ".env"))
...
'''
subprocesses = []
Functions = ["open", "close", "play", "system", "content", "click photo", "click screenshot", "shutdown", "restart", "sleep", "google search", "youtube search"]
